...
import com.milagros.ProcessImage;
...
public class Front extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    gradeInputText.setEditable(true);
  ...
  private void applyOCRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyOCRActionPerformed
    try { 
      ...
      String result = instance.doOCR(this.file);
      System.out.println("PRIMER PROCESO TERMINADO");
      String resultproc = instance.doOCR(finalImage);
      System.out.println("SEGUNDO PROCESO TERMINADO");
  ...
  private void gaussianBlurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gaussianBlurActionPerformed
    ProcessImage.applyGaussianBlur(this.tempImage, "temp.png");
    repairedImageLabel.setIcon(ResizeImage("temp.png"));
  ...
  private void grayScaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_grayScaleActionPerformed
    this.tempImage = ProcessImage.applyGrayscale(this.file.getAbsolutePath(), "temp.png");
    repairedImageLabel.setIcon(ResizeImage("temp.png"));
  ...
  private void morphologicalClosingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_morphologicalClosingActionPerformed
    try {
    int degree = Integer.parseInt(this.gradeInputText.getText());
    ProcessImage.applyMorphologicalClosing("temp.png", "temp1.png", degree);
    repairedImageLabel.setIcon(ResizeImage("temp1.png"));
    }
    catch(Exception e) {
      JOptionPane.showInternalMessageDialog(null, "Debe Ingresar un Número de Grado");
    }
  ...
  private void applyAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyAllActionPerformed
    this.tempImage = ProcessImage.applyGrayscale(this.file.getAbsolutePath(), "temp.png");
    ProcessImage.applyGaussianBlur(this.tempImage, "temp.png");
    ProcessImage.applyErodeAndDilate(this.tempImage, "temp.png");
    ProcessImage.applyBinaritazion(this.tempImage, "temp.png");
    int degree = Integer.parseInt(this.gradeInputText.getText());
    ProcessImage.applyMorphologicalClosing("temp.png", "temp1.png", degree);
    repairedImageLabel.setIcon(ResizeImage("temp1.png"));
